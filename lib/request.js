...
var callback = function callback(resolve, method, payload) {
    return function (res) {
...
var request = function request(options) {
    return new Promise(function (resolve, reject) {
        ...
        if (protocol === 'https:') {
            req = _https2.default.request(newOptions, callback(resolve)).end();
        } else if (protocol === 'http:') {
            req = _http2.default.request(newOptions, callback(resolve)).end();
        }
